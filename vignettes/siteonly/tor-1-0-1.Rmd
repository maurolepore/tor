...
I'm happy to announce that __tor__ 1.0.1 in now on CRAN! 

__tor__ (to-R) helps you to read multiple files from a single directory into R, as simply as possible. It makes a frequent task less painful. __tor__ is particularly useful during quick, exploratory data analysis and works well with the [tidyverse](https://www.tidyverse.org/). 

...
__tor__ does not write data because there are great and relatively simple tools for that. Yet it includes a helpter to create the paths to output files.

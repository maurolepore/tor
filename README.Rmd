...
There are great packages to read and write data, for example [__rio__](https://CRAN.R-project.org/package=rio) and [__io__](https://CRAN.R-project.org/package=io). __readwith__ does less than the alternatives, yet it is more flexible and small.
